...
So far in both \nameref{sec:loss_of_quantity} and \nameref{sec:great_merger} we mainly discussed the outcomes of \textbf{stressed} (\emph{tonic}) Latino-Romance vowels. The atonic vowels showed greater degrees of reduction than their tonic counterparts \parencite[p.~113]{lloyd_spanish}:
\begin{quote}
